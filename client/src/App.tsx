...
import CalendrierFormations from "@/pages/CalendrierFormations";
import BootcampStock from "@/pages/BootcampStock";
...
import Calendrier2026 from "@/pages/Calendrier2026";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/calendrier-formations" component={CalendrierFormations} />
      <Route path="/bootcamp-stock" component={BootcampStock} />
      ...
      <Route path="/calendrier-2026" component={Calendrier2026} />
      <Route path="/evenement/:slug" component={EventDetail} />
